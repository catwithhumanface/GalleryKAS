    ...
    <script>
        $(function(){
            $('.menu1 li').mouseenter(function(){
                $('.menu2 li',this).slideDown(100)
            }).mouseleave(function(){
                $('.menu2 li',this).slideUp(100)
            })
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
	  ...
	  <div id="login" >
		...
		<div class="inner2">
			<ul class="inner1">
			<c:choose>
				<c:when test="${Director=='Kim'}">
				<li class="current"><a href="exhibit.kas?m=exhibition&Dir=Kim"><strong>Kim's pick</strong></a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Ann">Ann's pick</a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Seo">Seo's pick</a>
				</li>
				</c:when>
				<c:when test="${Director=='Ann'}">
				<li class="current"><a href="exhibit.kas?m=exhibition&Dir=Kim">Kim's pick</a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Ann"><strong>Ann's pick</strong></a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Seo">Seo's pick</a>
				</li>
				</c:when>
				<c:when test="${Director=='Seo'}">
				<li class="current"><a href="exhibit.kas?m=exhibition&Dir=Kim">Kim's pick</a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Ann">Ann's pick</a>
				</li>
				<li ><a href="exhibit.kas?m=exhibition&Dir=Seo"><strong>Seo's pick</strong></a></a>
				</li>
				</c:when>
			</c:choose>
			</ul>
