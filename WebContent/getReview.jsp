...
<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color:white; !important;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 20px;">
	...
	<div class="inner">
		<ul>
			...
			<div class="r_list">
				<div class="choose">
                <form name="input" action="review.kas?m=edit&idx=${ReviewGot.idx}&code=${ReviewGot.code}" method="post">
                               <table border="1" width="600" align="center" cellpadding="3" cellspacing="1">
                                  <tbody>
                                  <tr>
                                 
                                     <td width="30%" align="center">전시명</td>
                                      <td align="center"><input type="text" name="exTitle" size="60" readonly value="${ReviewGotT}"></td>
                                     
                                  </tr>
                                  <tr>
                                     <td width="30%" align="center">글쓴이</td>
                                     
                                     <td align="center"><input type="text" name="writer" size="60" readonly value="${ReviewGot.name}"></td>
                                  </tr>
                                  <tr>
                                     <td align="center">이메일</td>
                                     <td align="center"><input type="text" name="email" size="60" readonly value="${ReviewGot.email}"></td>
                                  </tr>
                                  <tr>
                                     <td align="center">글제목</td>
                                     <td align="center"><input type="text" name="title" size="60" readonly value="${ReviewGot.title}"></td>
                                  </tr>
                                  <tr>
                                     <td align="center">글내용</td>
                                     <td align="center"><textarea name="content" rows="5" cols="53" style="width:500px; height:250px;" readonly >${ReviewGot.content}</textarea></td>
                                  </tr>
                                <tr>
                                     <td colspan='3' align='center'>
                                       
                                        <c:choose>
                                       <c:when test="${loginUser.email==ReviewGot.email}" >
                                       	 <input type='button' value='수정' onclick='check()' style='background-color:black; color:white; width:70px; line-height:50%; padding:3px;'>
                                       	 <input type='reset' value='다시입력' style='background-color:black; color:white; width:70px;  line-height:50%; padding:3px;'>
                                      	<a href="review.kas?m=delete&idx=${ReviewGot.idx}"style='display:inline;'><input type ='button' value='삭제'style='background-color:black; color:white; width:70px; line-height:50%; padding:3px;'></a>
                                       </c:when>
                                       	</c:choose>
                                     </td>
                                  </tr>
