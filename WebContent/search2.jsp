...
<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color:white; !important;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 20px;">
	...
	<div class="inner"> 
		...
		<c:if test="${empty SearchResult}">
				<p style='font-size:20px; margin-top:100px;color:#666666;'>검색결과가 없습니다.</p>
				</c:if>
		</div><strong></strong>
		</nav>
	...
	<section class="section1">
			<div class="kas_gall">
				...
				<c:if test="${!empty SearchResult}">
					...
					<li >
						<a href="exhibit.kas?m=exhibitBoard&Exh=${searchResult.code}">
							<figure><img src='${searchResult.poster}' alt=""></figure>
							<span class="category" style='color: #888888'>${searchResult.artist}</span>
							<span class="title">${searchResult.title}</span>
	                              <span class="date">${searchResult.e_date}</span>
						</a>
					</li>
					</c:forEach>
				</c:if>
