	  ...
	  <div class="d-flex justify-content-center h-100">
		<div class="card" style='border:0px;'>
		  <div class="card-body" align="center">
			<form name="f" action="member.kas?m=signup" method="post">
			  <p align="left" style="font-size:30px; margin-bottom:5px;">Sign Up</p>		  
			  <input type='text' name='email'  style='margin-bottom:3px;'placeholder=' 이메일 ' onkeyup='emailCheck(this.value); signinCheck();'>
			  <input type='text' name='name'  style='margin-bottom:-10px;'placeholder=' 이름' onkeyup='nameCheck(this.value); signinCheck();'>
			  <p></p>
			  <input type='password' style='margin-bottom:3px;' name='pwd' placeholder= ' 비밀번호' onkeyup='pwCheck(this.value); signinCheck();'>
			  <p></p>
			  <input type='submit' class="btn btn-signin btn-xl" style='margin-bottom:15px; background-color:#6666;!important;' value='가입완료' disabled>
			  <a href="member.kas?m=form" class="btn btn-signin btn-xl" style='margin-bottom:40%; background-color:#6666;!important;'>Sign In</a>
