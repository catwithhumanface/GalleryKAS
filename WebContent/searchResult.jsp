			...
			<div class="r_list">
				...
				<table>
					...
					<c:forEach items="${searchList}" var="searchList">
						<tr>
						<td>${searchList.idx}</td>
	                    <td><img src="${searchList.poster}" style='width:130px;'></td>
	                    <td><a class="title" href="review.kas?m=getReview&idx=${searchList.idx}">${searchList.title}</a></td>
	                    <td>${searchList.name}</td>
	                    <td>${searchList.w_date}</td>
	                    <td>${searchList.views}</td>
	                    </tr>
	                </c:forEach>
					</tbody>
