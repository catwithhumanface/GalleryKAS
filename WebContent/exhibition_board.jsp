<%@ page language="java" contentType="text/html;charset=utf-8" import="java.util.*, kas.domain.Exhibition"
    pageEncoding="utf-8"%>
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-color:white; !important;box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 20px;">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
	  ...
	  <div id="login" >
		...
		<div class="page-cover" style="padding-top:100px;"><div class="image" style="background-image:url(${ExContent.poster}); background-size:contain;"></div></div>
		
	

		<section id="about" class="section" style>
		<h1>${ExContent.title}</h1>

		<div class="detail" style=""><div class="info"><h3>Exhibition Details</h3> <p>${ExContent.title}<br>
						<br><span style='color:black'>Location</span><br>
						Bit Camp<br>
						#3 89<br> Mapo-daero Mapo-gu <br>Seoul Republic of Korea<br>
						
						</p> <h3>Artist</h3> <p><a href="#">${ExContent.artist} </a><br></p>
						
				<c:if test="${!empty loginUser}">
				            
				                  <a id="heart2" href="member.kas?m=likes&code=${ExContent.code}"><img id="heart" src="imgs/before.png" style='width:50px; height:50px;'></a>
				                   <c:set var="doneLoop" value="false"/>
				                     <c:forEach items="${likeList}" var="likelist">
				                        <c:choose>
				                           <c:when test="${likelist==ExContent.code}">
				                              <script>
				                                 document.getElementById("heart").src="imgs/after.png";
				                                 document.getElementById("heart2").href= "member.kas?m=likesOff&code=${ExContent.code}";      
				                              </script>
		...
		<section id="installation-views" class="section" style="">
			<h2>Installation Views</h2> 
		<div class="post-list column-2">
		<ul>
			<li>
				<figure>
					<img src="${PhotoContent1}">
				</figure>
			</li>
			
			<li>
				<figure>
					<img src="${PhotoContent2}" alt=""> 
				</figure>
			</li>
