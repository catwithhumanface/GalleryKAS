...
.r_list {padding:40px 0; width:1100px; height:700px; margin:0 auto;}
...
<body>
	<div class="wrap">
		...
		<header>
          <div class="logo_back" style="transition: all 0.5s ease 0s; background: rgb(255, 255, 255); box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 20px;">
          <div class="logo_main">
               <div class="main_this" >
                    <div class="main_1">
                    ...
                    <div class="menu">
                        <ul class="menu1">
                            <li class="th_menu"><a href="exhibit.kas?m=artists">Artists</a>
                            </li>
                            <li class="th_menu"><a href="exhibit.kas?m=exhibition">Exhibitions</a>
                            </li>
                            <li class="th_menu"><a href="review.kas?m=review">Review</a>
                            </li>
                            <li class="th_menu"><a href="exhibit.kas?m=about">About</a>
                            </li>
							<li class="th_menu"><a href="exhibit.kas?m=search">Search</a>
                            </li>
                        </ul>
                    </div>     
               </div>
